...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1920807250ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=newdj&table=raxit_signup&lang=en">`newdj`.`raxit_signup`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=newdj&table=raxit_video&lang=en">`newdj`.`raxit_video`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=newdj&table=raxit_videocommets&lang=en">`newdj`.`raxit_videocommets`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=raxit_vipl&table=vedansh_videocommets&lang=en">`raxit_vipl`.`vedansh_videocommets`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=newdj&table=auth_user&lang=en">`newdj`.`auth_user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=djangodb&table=auth_user&lang=en">`djangodb`.`auth_user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=raxit_vipl&table=auth_user&lang=en">`raxit_vipl`.`auth_user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=raxit_vipl&table=vedansh_signupuser&lang=en">`raxit_vipl`.`vedansh_signupuser`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=raxit_vipl&table=auth_permission&lang=en">`raxit_vipl`.`auth_permission`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=raxit_vipl&table=auth_user_groups&lang=en">`raxit_vipl`.`auth_user_groups`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="527042595d2c777e7e7c7d2c4f4d5060">
